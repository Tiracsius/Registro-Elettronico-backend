...
public class TeacherController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TeacherInfo> getById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TeacherInfo> update(@PathVariable Long id, @RequestBody TeacherInfo data) {
